...
MakeKeyAttribute3Hash() {
	...
	keyAttribute3["RNA07"] := ""
	keyAttribute3["RKA07"] := ""
	keyAttribute3["ANA08"] := "X"	;左Alt
	keyAttribute3["AKA08"] := "X"
	keyAttribute3["RNA08"] := "X"
	keyAttribute3["RKA08"] := "X"
	keyAttribute3["ANA09"] := "X"	;右Alt
	keyAttribute3["AKA09"] := "X"
	keyAttribute3["RNA09"] := "X"
	keyAttribute3["RKA09"] := "X"
